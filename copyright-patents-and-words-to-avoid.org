...
"Intellectual property" purports to be a catch all term for trademarks, patents, and copyright. However, these three sets of laws developed independantly and do not have a common basis. The term "intellectual property" distorts the issues by making an analogy to physical property. The term intellectual monopoly priviledges, (IMPs) has been suggested instead.
** LAMP System
